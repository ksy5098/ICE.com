...
public final class CardLayoutBinding implements ViewBinding {
  ...
  private CardLayoutBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout mainLayout, @NonNull TextView productDetail,
      @NonNull ImageView productImg, @NonNull TextView productName,
  ...
  public static CardLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CardLayoutBinding((ConstraintLayout) rootView, mainLayout, productDetail,
          productImg, productName, productPrice);
    }
